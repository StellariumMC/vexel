...
dependencies {
    // For Fabric 1.21.5
    modImplementation(include("xyz.meowing:vexel-1.21.5-fabric:1.0.3")!!)
    
    // For Fabric 1.21.7
    modImplementation(include("xyz.meowing:vexel-1.21.7-fabric:1.0.3")!!)

    // For Forge 1.8.9
    shadowImpl("xyz.meowing:vexel-1.8.9-forge:1.0.3")
}
```
