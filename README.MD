...
dependencies {
    // For Fabric 1.21.9
    modImplementation(include("xyz.meowing:vexel-1.21.9-fabric:1.0.6")!!)

    // For Fabric 1.21.7
    modImplementation(include("xyz.meowing:vexel-1.21.7-fabric:1.0.6")!!)

    // For Fabric 1.21.5
    modImplementation(include("xyz.meowing:vexel-1.21.5-fabric:1.0.6")!!)
